                    ...
                    </div>
                    {
                        user ? (
                            <div className="flex items-center">
                                ...
                                <div
                                    ...
                                    <div className="grid grid-cols-3 gap-4 p-4">
                                        <button onClick={handleSignOut} type="button"
                                            className="w-full block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <div ref={userMenuRef} className="relative flex items-center ml-3">
                                    <div>
                                        <button type="button"
